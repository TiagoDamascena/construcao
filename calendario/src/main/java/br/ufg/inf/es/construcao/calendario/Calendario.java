...
/**
 * Serviços oferecidos para manipulação de informações de calendário.
 */
public class Calendario {
     ...
     * @return O valor 0 para segunda-feira, 1 para terça-feira e assim
     * sucessivamente.
     * @throws IllegalArgumentException Caso o dia, o mês ou o ano fornecidos
     * não estejam na faixa admitida. O dia deve ser um valor de 1 a 31,
     * inclusive. O mês deve ser um valor de 1 a 12, inclusive. O ano deve ser
